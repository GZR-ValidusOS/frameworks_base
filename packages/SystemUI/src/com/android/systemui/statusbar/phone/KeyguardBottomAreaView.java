...
import com.android.systemui.validus.LockscreenShortcutsHelper;
import com.android.systemui.validus.LockscreenShortcutsHelper.Shortcuts;
...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    private boolean hideShortcuts() {
        return (Settings.Secure.getIntForUser(getContext().getContentResolver(),
                Settings.Secure.HIDE_LOCKSCREEN_SHORTCUTS, 0, UserHandle.USER_CURRENT) == 0);
    }
}
